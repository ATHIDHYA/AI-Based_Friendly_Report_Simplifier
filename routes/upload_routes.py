...
@jwt_required()
def api_upload():
    """API endpoint for React frontend with JWT authentication"""
    return _handle_upload(api_mode=True)


def _handle_upload(api_mode=False):
    ...
    # Check if request expects JSON (from React frontend)
